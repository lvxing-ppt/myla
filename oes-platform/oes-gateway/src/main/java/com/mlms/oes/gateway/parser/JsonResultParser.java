package com.mlms.oes.gateway.parser;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mlms.oes.common.api.dto.UnifiedResult;
import com.mlms.oes.common.core.exception.ParseException;
import com.mlms.oes.gateway.core.spi.DataParser;
 ...
 * <p>
 * 适用于仪器直接发送 JSON 格式数据的场景。配合 {@link com.mlms.oes.gateway.splitter.RawPassthroughSplitter} 使用。
 * </p>
 *
 * <h3>子类扩展：</h3>
