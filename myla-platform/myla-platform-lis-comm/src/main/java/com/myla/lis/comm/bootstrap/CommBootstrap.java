...
import com.myla.lis.comm.config.LisCommProperties;
import com.myla.lis.comm.config.LisCommProperties.InstrumentProps;
import com.myla.lis.comm.config.LisCommProperties.ChannelProps;
 ...
 * 替代原来 myla-server 中的 GatewayBootstrap + LisInboundServer 的配置读取部分。
 * </p>
 */
@Slf4j
@Component
